...
const baseStyles = {
    solid: 'group inline-flex items-center justify-center rounded-full  text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2',
    outline:
        'group inline-flex ring-1 items-center justify-center rounded-full  text-sm focus:outline-none',
}

const variantStyles = {
    solid: {
        white: 'bg-white text-slate-900 hover:bg-blue-50 active:bg-blue-200 active:text-slate-600 focus-visible:outline-white',
        slate: '  active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900',
